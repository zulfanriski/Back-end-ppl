   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <span>update Nomer Telepon :</span>
            <input type="text" name="update_namausaha" value="<?php echo $fetch['nomertlp']; ?>" class="box">
            <span>update Alamat :</span>
            <input type="text" name="update_deskripsi" value="<?php echo $fetch['alamat']; ?>" class="box">
