...
class Login {
    ...
    public function validateUser($nama, $password) {
       ...
       $select = mysqli_query($this->conn, "SELECT * FROM `mitra` WHERE name = '$nama' AND password = '$password'") or die('query failed');
      ...
      class UserUpdater {
        ...
        public function updateProfile() {
           if(isset($_POST['update_profile'])){
            ...
            mysqli_query($this->conn, "UPDATE `mitra` SET name = '$update_name', email = '$update_email', namausaha = '$update_namausaha', visimisi = '$update_deskripsi' WHERE id_mitra = '$this->user_id'") or die('query failed');
              ...
              if(!empty($update_image)){
                 if($update_image_size > 2000000){
                    ...
                    $image_update_query = mysqli_query($this->conn, "UPDATE `mitra` SET image = '$update_image' WHERE id_mitra = '$this->user_id'") or die('query failed');
